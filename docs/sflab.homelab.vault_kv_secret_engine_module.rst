.. _sflab.homelab.vault_kv_secret_engine_module:
...
**Configures a KV secret engine in HashiCorp Vault**
...
Synopsis
--------
- Ensures a `KV secret engine <https://developer.hashicorp.com/vault/docs/secrets/kv>`_ is configured as expected in HashiCorp Vault.
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>If not provided, this will default to an empty list for new secret engines.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The default lease TTL of the secret engine.</div>
                        <div>This value can be provided as a duration string, such as V(72h), or as an number of seconds.</div>
                        <div>If not provided, this will default to V(32d) for new secret engines.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        ...
                        <div>If not provided, the description will default to an empty string for new secret engines.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The version of the KV secret engine to use.</div>
                        <div>Version 1 does not support versioning of secrets.</div>
                        <div>Version 2 supports versioning of secrets.</div>
                        <div>Reference: https://developer.hashicorp.com/vault/docs/secrets/kv</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        ...
                        <div>If not provided, this will default to V(normal) for new secret engines.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The maximum lease TTL of the secret engine.</div>
                        <div>This value can be provided as a duration string, such as V(72h), or as an number of seconds.</div>
                        <div>This value must be greater than or equal to the value of O(default_lease_ttl).</div>
                        <div>If not provided, this will default to V(32d) for new secret engines.</div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>replace_different_backend_type</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                ...
                <td>
                        <div>Whether to replace the secret engine if it has a different backend type.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Whether the secret engine should be present or absent.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>The configuration of the secret engine.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;description&#x27;: &#x27;The KV secret engine.&#x27;, &#x27;default_lease_ttl&#x27;: 2678400, &#x27;max_lease_ttl&#x27;: 2678400, &#x27;audit_non_hmac_request_keys&#x27;: [], &#x27;audit_non_hmac_response_keys&#x27;: [], &#x27;listing_visibility&#x27;: &#x27;unauth&#x27;, &#x27;passthrough_request_headers&#x27;: []}</div>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>changed</td>
                <td>
                            <div>The previous configuration of the secret engine.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;description&#x27;: &#x27;The KV secret engine.&#x27;, &#x27;default_lease_ttl&#x27;: 2678400, &#x27;max_lease_ttl&#x27;: 2678400, &#x27;audit_non_hmac_request_keys&#x27;: [], &#x27;audit_non_hmac_response_keys&#x27;: [], &#x27;listing_visibility&#x27;: &#x27;unauth&#x27;, &#x27;passthrough_request_headers&#x27;: []}</div>
                </td>
