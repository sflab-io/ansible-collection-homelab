.. _sflab.homelab.vault_pki_secret_engine_module:
...
**Configures a PKI secret engine in HashiCorp Vault**
...
Synopsis
--------
- Ensures a `PKI secret engine <https://hvac.readthedocs.io/en/stable/usage/secrets_engines/pki.html>`_ is configured as expected in HashiCorp Vault.
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        ...
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;description&#x27;: &#x27;The PKI secret engine.&#x27;, &#x27;default_lease_ttl&#x27;: 2678400, &#x27;max_lease_ttl&#x27;: 2678400, &#x27;audit_non_hmac_request_keys&#x27;: [], &#x27;audit_non_hmac_response_keys&#x27;: [], &#x27;listing_visibility&#x27;: &#x27;unauth&#x27;, &#x27;passthrough_request_headers&#x27;: []}</div>
                </td>
            </tr>
                                <tr>
