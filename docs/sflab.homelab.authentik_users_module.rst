.. _sflab.homelab.authentik_users_module:
...
**Synchronizes NetBox contact groups and contacts to Authentik groups and users**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The NetBox API token used to authenticate against the NetBox API.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        ...
                        <div>Example: https://netbox.home.sflab.io</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The number of Authentik groups that were newly created during this run.</div>
                    <br/>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The number of Authentik groups that were deleted during this run.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The number of group membership assignments that were newly created during this run.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The number of Authentik users that were newly created during this run.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">5</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The number of Authentik users that were deleted during this run.</div>
                    <br/>
                </td>
            </tr>
    </table>
