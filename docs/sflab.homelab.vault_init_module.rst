.. _sflab.homelab.vault_init_module:


************************
sflab.homelab.vault_init
************************

**Initializes a HashiCorp Vault instance.**
...
Synopsis
--------
- `Initializes <https://python-hvac.org/en/stable/usage/system_backend/init.html#initialize>`_ a HashiCorp Vault instance.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The list of PGP public keys used to encrypt the output unseal keys.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The PGP public key used to encrypt the root token.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The number of shares to split the master key into.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>secret_threshold</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                         / <span style="color: red">required</span>
                ...
                <td>
                        <div>The number of shares required to reconstruct the master key.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
...
not check_mode</td>
                <td>
                            <div>The unseal keys in base64 format.</div>
                    <br/>
                </td>
            </tr>
            <tr>
...
not check_mode</td>
                <td>
                            <div>The unseal keys in hexadecimal format.</div>
                    <br/>
                </td>
            </tr>
            <tr>
