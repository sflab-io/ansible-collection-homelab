.. _sflab.homelab.vault_pki_set_signed_intermediate_module:
...
**Sets a signed intermediate CA certificate for a PKI secret engine**
...
Synopsis
--------
- `Sets a signed intermediate CA certificate <https://hvac.readthedocs.io/en/stable/usage/secrets_engines/pki.html#set-signed-intermediate>`_ for a PKI secret engine.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The PEM-encoded signed intermediate CA certificate.</div>
                        <div>This can include the signing certificate chain.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
