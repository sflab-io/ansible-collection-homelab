...
```yaml
- name: Initialize the vault role from sflab.homelab
  hosts: servers
  gather_facts: false
  tasks:
    - name: Trigger invocation of vault role
      ansible.builtin.include_role:
        name: sflab.homelab.vault
      vars:
        vault_x: 42
```
