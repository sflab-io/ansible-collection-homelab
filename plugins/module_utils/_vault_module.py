...
from ansible_collections.community.hashi_vault.plugins.module_utils._authenticator import (
...
try:
    ...
    class VaultModule(HashiVaultModule):
        ...
        def get_defined_non_connection_params(self) -> dict:
            ...
            delete_keys: list[str] = [
                key for key in self.params.keys() if key in HashiVaultAuthenticator.ARGSPEC
            ]
